...
public class HomeInventory extends JFrame
{
    ...
    public HomeInventory(){
        ...
        nextButton.addActionListener(new ActionListener()
        {
            ...
            gridConstraints.gridx = 2;
            gridConstraints.gridy = 1;
            gridConstraints.gridwidth = 3;gridConstraints.insets = new Insets(10, 0, 0, 10);
            gridConstraints.anchor = GridBagConstraints.WEST;
...
{
// check for descriptionitemTextField.setText(itemTextField.getText().trim());
...
{
myInventory[i - 1] = myInventory[i - 2];myInventory[i - 2] = new InventoryItem();
}
}
...
// draw border
g2D.setPaint(Color.BLACK);g2D.draw(new Rectangle2D.Double(0, 0, getWidth() - 1, getHeight() - 1));
// show photo
